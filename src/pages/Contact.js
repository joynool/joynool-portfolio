  ...
  return (
    <section id="contact" className="container">
      <div className="flex justify-center items-center px-5 py-10">
        <form
          onSubmit={sendEmail}
          className="lg:w-2/3 md:w-1/2 flex flex-col w-full md:px-8 md:py-8 mt-8 md:mt-0 p-3 border-2 rounded-lg wow animate__animated animate__fadeInUp"
        >
