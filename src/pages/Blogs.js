...
const Blogs = () => {
  return (
    <section className="bg-gray-900 flex flex-col justify-center items-center py-3">
      <header className="pt-16 pb-5 sm:text-center">
        <h1 className="mb-4 text-3xl sm:text-4xl tracking-tight text-white font-extrabold">
          <ImQuotesLeft className="relative left-40 top-5 text-gray-400" />
          &nbsp;&nbsp;Blogs
        </h1>
      ...
      <main className="flex flex-col justify-center items-center mb-10">
        <div className="border-b-2 text-white p-5 rounded-2xl w-3/4 h-auto mb-5">
          <h1 className="bg-white rounded-full text-black p-1">
        ...
        <div className="border-b-2 text-white p-5 rounded-2xl w-3/4 h-auto mb-5">
          ...
          <p className=" leading-8">
            ...
            pivotal in allowing us to deliver highly scalable, data-intensive,
            real-time back-end services to power the websites and apps for me.
            <button className="inline-flex text-white bg-green-500 border-0 ml-2 px-2 focus:outline-none hover:bg-green-600 rounded text-lg">
              Read More
            </button>
          </p>
        </div>
        <div className="border-b-2 text-white p-5 rounded-2xl w-3/4 h-auto">
          <h1 className="bg-white rounded-full text-black p-1">
            # Next.js - what is it and why do we use it?
          </h1>
          <p className=" leading-8">
